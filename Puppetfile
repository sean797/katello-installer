...
mod 'katello/capsule', :git => 'https://github.com/iNecas/puppet-capsule', :ref => 'issue/6875'
mod 'katello/certs', :git => 'https://github.com/iNecas/puppet-certs', :ref => 'issue/6875'
